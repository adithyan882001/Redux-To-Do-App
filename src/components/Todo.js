...
const Todo = () => {
    ...
    <div className="main-div">
      <div className="child-div">
        <figure>
          <figcaption className='fig-caption'><h2>TO-DO LIST</h2></figcaption>
        </figure>
        <div className='addItems'>
          <input type="text" placeholder="Enter To-Do's" value={inputData} onChange= {(event) => setInputData(event.target.value)}/>
